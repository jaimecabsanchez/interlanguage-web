...
assert.match(modeBlock, /href:"practicar\.html"/, "una skill no disponible vuelve al centro Practicar");
assert.match(modeBlock, /hasPractice \?[^:]*\{ href:"practicar\.html"[\s\S]*: null/, "Inicio solo se usa cuando no queda práctica compatible");
