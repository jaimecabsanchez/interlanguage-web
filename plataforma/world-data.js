...
(function (root, factory) {
  ...
  const CATALOG = Object.freeze([
    ...
    { id:"hair-waves", category:"avatar", section:"Pelo", name:"Ondulado", nameEn:"Wavy", visual:"hair-waves", settingKey:"avatarHair", settingValue:"waves", bands:ALL, unlock:missions(2) },
    { id:"hair-curls", category:"avatar", section:"Pelo", name:"Rizado", nameEn:"Curly", visual:"hair-curls", settingKey:"avatarHair", settingValue:"curls", bands:ALL, unlock:missions(5) },
    { id:"hair-long", category:"avatar", section:"Pelo", name:"Largo", nameEn:"Long", visual:"hair-long", settingKey:"avatarHair", settingValue:"long", bands:ALL, unlock:missions(8) },
    ...
    { id:"hair-gold", category:"avatar", section:"Color de pelo", name:"Rubio", nameEn:"Blonde", visual:"hair-gold", settingKey:"avatarHairColor", settingValue:"gold", bands:ALL, unlock:missions(3) },
    { id:"hair-copper", category:"avatar", section:"Color de pelo", name:"Cobrizo", nameEn:"Copper", visual:"hair-copper", settingKey:"avatarHairColor", settingValue:"copper", bands:ALL, unlock:missions(5) },
