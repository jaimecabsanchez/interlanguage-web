...
const base = { avatarBase:"masculine", avatarSkin:"tone-2", avatarHair:"short", avatarHairColor:"dark", avatarFaceShape:"oval", avatarFaceWidth:2, avatarEyeShape:"almond", avatarEyeColor:"brown", avatarEyeSize:2, avatarBrowShape:"soft", avatarNoseShape:"soft", avatarNoseLength:2, avatarMouthShape:"smile", avatarTheme:"navy", avatarTop:"tee", avatarAccessory:"none", worldBackground:"day", activeWorldItems:[] };
...
console.log("world-visual: 15 comprobaciones correctas");
