...
(function (root, factory) {
  ...
  const PRACTICE = Object.freeze({
    p12:Object.freeze({ title:"¿Qué practicamos hoy?", subtitle:"Elige una opción y avanzamos paso a paso.", recommended:"Lo mejor para hoy", dailyTitle:"Tu misión de hoy", dailyBody:"Primero completa tu misión. Después podrás practicar más.", dailyCta:"Ir a mi misión", dueBody:"Hay algunas cosas listas para practicar otra vez.", skillBody:"Hoy te ayudará practicar {skill}.", extraBody:"Una práctica corta para seguir avanzando.", start:"Empezar", reviewTitle:"Repasar", reviewBody:"Vamos a practicar otra vez algunas cosas.", reviewEmpty:"Todo listo por ahora", chooseTitle:"Elige qué practicar", chooseBody:"Escoge una opción. Será una práctica aparte.", dailyTime:"Unos 5 minutos", reviewTime:"3–5 minutos", skillTime:"Unos 5 minutos", dailyOutcome:"Completarla marcará el día en Mi semana.", reviewOutcome:"Practicarás otra vez sin cambiar tu misión.", skillOutcome:"Tu misión de hoy no cambiará.", unavailableTitle:"Esta práctica todavía no está disponible", unavailableBody:"Elige otra forma de practicar.", alternativesTitle:"Puedes practicar esto", noContentTitle:"Todavía no hay práctica preparada", noContentBody:"Puedes volver a Inicio. Tu progreso está guardado.", backPractice:"Volver a Practicar", backHome:"Volver a Inicio" }),
    p34:Object.freeze({ title:"Practicar", subtitle:"Elige cómo quieres reforzar tu inglés.", recommended:"Recomendado para ti", dailyTitle:"Completa tu misión", dailyBody:"Tu misión de hoy sigue pendiente. Es el mejor siguiente paso.", dailyCta:"Continuar misión", dueBody:"Tienes contenido listo para repasar.", skillBody:"Practicar {skill} te ayudará a afianzar lo aprendido.", extraBody:"Una ronda corta para seguir avanzando.", start:"Practicar", reviewTitle:"Repasar", reviewBody:"Practica otra vez lo que más cuesta.", reviewEmpty:"No tienes nada pendiente", chooseTitle:"Elegir qué practicar", chooseBody:"Cada opción abre una sesión breve e independiente.", dailyTime:"6–8 minutos", reviewTime:"4–6 minutos", skillTime:"6 minutos", dailyOutcome:"Al terminar, completarás el día de tu misión.", reviewOutcome:"Reforzarás lo que más cuesta sin alterar tu misión.", skillOutcome:"Registrarás progreso en esta habilidad sin alterar tu misión.", unavailableTitle:"Esta práctica todavía no está disponible", unavailableBody:"Puedes elegir otra opción compatible.", alternativesTitle:"Otras prácticas disponibles", noContentTitle:"Práctica no disponible", noContentBody:"Todavía no hay contenido compatible para practicar.", backPractice:"Volver a Practicar", backHome:"Volver a Inicio" }),
    p56:Object.freeze({ title:"Practicar", subtitle:"Elige una práctica breve según lo que necesitas hoy.", recommended:"Recomendado para ti", dailyTitle:"Primero, tu misión", dailyBody:"Tu misión diaria sigue pendiente. Complétala antes de la práctica extra.", dailyCta:"Continuar misión", dueBody:"Tienes contenido listo para review.", skillBody:"Un poco de {skill} es la mejor opción ahora.", extraBody:"Práctica extra adaptada a tu nivel.", start:"Practicar ahora", reviewTitle:"Repasar puntos clave", reviewBody:"Vuelve a lo que necesita un poco más de práctica.", reviewEmpty:"Todo al día", chooseTitle:"Elegir habilidad", chooseBody:"Elige un foco para una sesión independiente.", dailyTime:"8 minutos", reviewTime:"5–7 minutos", skillTime:"8 minutos", dailyOutcome:"Completarla cerrará tu objetivo de hoy.", reviewOutcome:"Actualizarás tu dominio sin modificar la misión diaria.", skillOutcome:"Guardarás intentos, tiempo y progreso de la habilidad.", unavailableTitle:"Esta práctica todavía no está disponible", unavailableBody:"Elige otra habilidad con contenido preparado.", alternativesTitle:"Alternativas disponibles", noContentTitle:"Práctica no disponible", noContentBody:"No hay contenido compatible disponible ahora mismo.", backPractice:"Volver a Practicar", backHome:"Volver a Inicio" }),
    eso:Object.freeze({ title:"Practice", subtitle:"Choose a focused session for what you need today.", recommended:"Recommended for you", dailyTitle:"Complete today’s session", dailyBody:"Your daily session is still pending and remains the priority.", dailyCta:"Continue session", dueBody:"You have review items ready.", skillBody:"A focused {skill} session is the strongest next step.", extraBody:"A short extra session matched to your level.", start:"Start practice", reviewTitle:"Review", reviewBody:"Revisit the items that need another attempt.", reviewEmpty:"Everything is up to date", chooseTitle:"Choose a skill", chooseBody:"Start an independent, focused practice session.", dailyTime:"About 10 minutes", reviewTime:"5–7 minutes", skillTime:"About 10 minutes", dailyOutcome:"Finishing it will complete today’s objective.", reviewOutcome:"This updates mastery without changing your daily session.", skillOutcome:"Attempts, time and skill evidence will be saved.", unavailableTitle:"This practice is not available yet", unavailableBody:"Choose another available practice.", alternativesTitle:"Available alternatives", noContentTitle:"Practice unavailable", noContentBody:"There is no compatible practice content available right now.", backPractice:"Back to Practice", backHome:"Back to home" }),
    neutral:Object.freeze({ title:"Practicar", subtitle:"Elige una práctica disponible.", recommended:"Recomendado", dailyTitle:"Tu misión de hoy", dailyBody:"Tu misión sigue pendiente y es el siguiente paso recomendado.", dailyCta:"Ir a la misión", dueBody:"Hay contenido listo para repasar.", skillBody:"Puedes practicar {skill}.", extraBody:"Una práctica breve disponible.", start:"Practicar", reviewTitle:"Repasar", reviewBody:"Practica de nuevo algunos contenidos.", reviewEmpty:"Todo listo por ahora", chooseTitle:"Elegir práctica", chooseBody:"Solo mostramos opciones compatibles.", dailyTime:"5–8 minutos", reviewTime:"5 minutos", skillTime:"5–8 minutos", dailyOutcome:"Completarla marcará tu objetivo diario.", reviewOutcome:"La misión diaria conservará su estado.", skillOutcome:"La misión diaria conservará su estado.", unavailableTitle:"Esta práctica todavía no está disponible", unavailableBody:"Elige otra práctica disponible.", alternativesTitle:"Alternativas disponibles", noContentTitle:"Práctica no disponible", noContentBody:"No hay contenido compatible disponible ahora mismo.", backPractice:"Volver a Practicar", backHome:"Volver a Inicio" })
  });
  ...
  function practiceSkill(id, band) {
    ...
    const growing = { listening:"Listening · Escuchar", vocabulary:"Vocabulary · Palabras", speaking:"Speaking · Hablar", reading:"Reading · Leer" };
    if (safeBand === "p12" && young[id]) return young[id];
    if (safeBand === "p34" && growing[id]) return growing[id];
    return skill(id, safeBand);
  }
